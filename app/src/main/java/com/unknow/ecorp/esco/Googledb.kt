...
import kotlinx.android.synthetic.main.activity_googledb.*
import org.json.JSONArray
import org.json.JSONObject

class Googledb : AppCompatActivity() {

    var LOG_TAG = "dvdgonzalez"

    var SPREAD_SHEET_ID = "1iKZAcH3JfgePsIlbzNuWjT92qQeRJpKHyx9Ny4h8Tyo"
    var TABLE_AUTOS = "Autos"

    //IMPORTANTE: estas URL tienes que cambiarlas por las de tus propios scripts
    var sheetInJsonURL = "https://script.google.com/macros/s/AKfycbzlAFGA1V_6kH2k9uv3zWdE_SguV5xE6MW9UKxOwL1h2dEMO0Px/exec?spreadsheetId=$SPREAD_SHEET_ID&sheet="
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_googledb)
    ...
    fun getUsers(){
        ...
        val jsonArrayRequest = JsonArrayRequest(Request.Method.GET, sheetInJsonURL + TABLE_AUTOS, null,
    ...
    fun addUsers(){
        ...
        jsonObject.put("sheet", TABLE_AUTOS)
